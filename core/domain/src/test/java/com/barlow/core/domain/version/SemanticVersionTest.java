...
class SemanticVersionTest {
	...
	private static Stream<Arguments> generateSuffixCompareData() {
		return Stream.of(
			...
			Arguments.of("1.0.0-snapshot", "1.0.0-snapshot", false), Arguments.of("1.0.0-alpha", "1.0.0-beta", true),
			Arguments.of("1.0.0-beta", "1.0.0-rc", true), Arguments.of("1.0.0-rc", "1.0.0", true));
	}
	...
	private static Stream<Arguments> generateCompareData() {
		return Stream.of(
			Arguments.of("1.0.0", "1.0.1", true), Arguments.of("1.0.0", "1.0.0", false),
			Arguments.of("1.0.1", "1.1.0", true), Arguments.of("1.1.1", "2.1.0", true));
	}
}
