package com.barlow.batch.admin.common;
...
@Component
@StepScope
public class AdminStepLoggingListener implements StepExecutionListener {

	private static final Logger log = LoggerFactory.getLogger(AdminStepLoggingListener.class);
