...
@Component
@StepScope
public class WriteBillLegislationBodyStepListener
	...
	public WriteBillLegislationBodyStepListener(
	...
	public void beforeStep(StepExecution stepExecution) {
		...
		if (stepExecution.getExecutionContext().get(BILL_LEGISLATION_READER_INDEX_KEY) != null) {
		...
		BillInfoBatchEntity billsWithFewProposers = billInfo.filterHasLegislationBodyBills();
		...
		super.putDataToExecutionContext(BILL_WITH_LEGISLATION_BODY_SHARE_KEY, newHashKey);
