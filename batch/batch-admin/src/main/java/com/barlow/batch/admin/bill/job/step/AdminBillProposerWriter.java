...
import static com.barlow.batch.admin.bill.LawmakerProvider.Lawmaker;
...
@Component
@StepScope
public class AdminBillProposerWriter implements ItemWriter<BillProposer> {
	...
	public AdminBillProposerWriter(@Qualifier("batchCoreDataSource") DataSource dataSource) {
