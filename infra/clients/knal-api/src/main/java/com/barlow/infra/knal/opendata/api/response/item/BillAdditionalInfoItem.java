...
public record BillAdditionalInfoItem(
	...
	public record CommMemoItem(String commMemo // 비고
	) {
	}

	public record ExhaustItem(String billLink, // 대안반영폐기 링크 경로
		String billName // 대안반영폐기 의안명
	) {
	}

	public record BillGbnCdItem(String billLink, // 대안링크경로
