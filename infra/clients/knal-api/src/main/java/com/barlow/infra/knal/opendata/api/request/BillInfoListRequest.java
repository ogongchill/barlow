package com.barlow.infra.knal.opendata.api.request;

import com.barlow.infra.knal.opendata.api.Operation;
import com.barlow.infra.knal.opendata.api.code.BillKindCode;
import com.barlow.infra.knal.opendata.api.code.CommitteeCode;
import com.barlow.infra.knal.opendata.api.code.CommitteeResultCode;
import com.barlow.infra.knal.opendata.api.code.PlenarySessionResultCode;
import com.barlow.infra.knal.opendata.api.code.ProposerCode;
...
/**
 * <a href="https://www.data.go.kr/data/3037286/openapi.do">IROS4_OA_DV_0401_OpenAPI활용가이드_의안정보(국회사무처)_v1.30<</a></href>의 <resultCode>getBillInfoList</resultCode>오퍼레이션의 요청 파라미터임
 * @see Operation
...
public class BillInfoListRequest {
	...
	public static class Builder {
		...
		public Builder currCommittee(CommitteeCode currCommitteeCode) {
			this.currentCommittee = currCommitteeCode.getCode();
			return this;
		}
