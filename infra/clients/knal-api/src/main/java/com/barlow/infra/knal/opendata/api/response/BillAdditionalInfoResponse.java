...
public record BillAdditionalInfoResponse(SuccessHeader header,
	GenericItemBody<BillAdditionalInfoItem> body) implements OpenDataResponse<BillAdditionalInfoItem> {
}
