...
public record SessionRequestListResponse(SuccessHeader header,
	ItemResponseBody<SessionRequestListItem> body) implements OpenDataResponse<SessionRequestListItem> {
}
