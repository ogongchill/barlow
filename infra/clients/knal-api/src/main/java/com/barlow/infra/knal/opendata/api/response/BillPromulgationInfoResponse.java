...
import com.barlow.infra.knal.opendata.api.response.item.BillPromulgationInfoItem;

public record BillPromulgationInfoResponse(SuccessHeader header,
	ItemResponseBody<BillPromulgationInfoItem> body) implements OpenDataResponse<BillPromulgationInfoItem> {
