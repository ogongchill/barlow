...
public record LegislationAccountBillPostDetailResponse(String title, String proposerSummary, String proposerType,
	String legislativeBody, LocalDate createdAt, String detail, SummarySection summarySection,
	...
	record ProposerResponse(String name, String profileImage, String partyName) {
