...
class BillPostDetailApiSpecComposerTest {
	...
	void getProposerPartyRate() {
		RecentBillPostDetailApiSpecComposer.BillProposers billProposers = new RecentBillPostDetailApiSpecComposer.BillProposers(
			List.of(PROPOSER));
	...
	void mapToProposerResponse() {
		...
		List<RecentBillPostDetailResponse.ProposerResponse> expect = List
			.of(new RecentBillPostDetailResponse.ProposerResponse(PROPOSER_NAME, PROFILE_IMAGE_PATH, PARTY_NAME));
	...
	void compose() {
		...
		List<RecentBillPostDetailResponse.ProposerResponse> expectProposerResponses = List
			.of(new RecentBillPostDetailResponse.ProposerResponse(PROPOSER_NAME, PROFILE_IMAGE_PATH, PARTY_NAME));
		assertAll(
