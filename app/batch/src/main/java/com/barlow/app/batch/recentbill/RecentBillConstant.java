...
public final class RecentBillConstant {
	...
	public static final String BILL_AI_SUMMARY_SHARE_KEY = "BILL_AI_SUMMARY";
	public static final String BILL_AI_BACKGROUND_REQUEST_SHARE_KEY = "BILL_AI_BACKGROUND_REQUEST";
}
