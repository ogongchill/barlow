...
**core:domain**
- [ ] 순수 POJO — Spring 어노테이션(`@Entity`, `@Service` 등) 없음
- [ ] setter 없음. 상태 변경 = 새 인스턴스 반환 (`with` / `activate` / `deactivate`)
