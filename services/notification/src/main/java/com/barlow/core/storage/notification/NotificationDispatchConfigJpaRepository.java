...
public interface NotificationDispatchConfigJpaRepository extends JpaRepository<NotificationConfigJpaEntity, Long> {
	...
	Slice<NotificationInfoProjection> findAllByEnableTrueAndTopic(
		@Param("topic") NotificationTopic topic,
		Pageable pageable
	);
	...
	Slice<NotificationInfoProjection> findAllByEnableTrueAndTopicIn(
		@Param("topics") Set<NotificationTopic> topics,
		Pageable pageable
	);
}
