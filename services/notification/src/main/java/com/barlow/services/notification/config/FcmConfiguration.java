package com.barlow.services.notification.config;
...
public class FcmConfiguration {
	...
	private static final String FIREBASE_APP_NAME = "barlow";

	private final String firebaseConfigPath;

	public FcmConfiguration(@Value("${firebase.fcm.config.path}") String firebaseConfigPath) {
